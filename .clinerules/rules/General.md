...
- As a product manager, identify any gaps in user needs. Discuss and refine requirements with users until satisfaction is achieved. As a result, build detailed plan of the task execution with step by step breakdown.
...
- Report to the user on the fact of the implementation of each item of the previously agreed task execution plan.
